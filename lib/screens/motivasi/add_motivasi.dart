...
class add_motivasi extends StatefulWidget {
  final String idname;
  add_motivasi(this.idname);

  @override
  State<add_motivasi> createState() => _add_motivasiState();
}

class _add_motivasiState extends State<add_motivasi> {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  bool response =
                      await repository.addMotivasi(_isi.text, "$name");
